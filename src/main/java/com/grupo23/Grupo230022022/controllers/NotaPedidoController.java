...
import com.grupo23.Grupo230022022.entities.Curso;
import com.grupo23.Grupo230022022.entities.Final;
...
public class NotaPedidoController {
	...
	public RedirectView create_sussces_curso(@ModelAttribute("curso") Curso curso, RedirectAttributes redirectAttributes){
	...
	public RedirectView create_sussces_final(@ModelAttribute("final") Final finall, RedirectAttributes redirectAttributes){
